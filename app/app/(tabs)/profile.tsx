...
export default function ProfileScreen() {
  ...
  const [engineSuggestions, setEngineSuggestions] = useState<{ name: string; power: string; fuel: string }[]>([]);
  ...
  const selectEngine = (engine: { name: string; power: string; fuel: string }) => {
      ...
      >
        ...
        <View style={styles.section}>
          ...
          {loading ? (
                ...
                >
                  ...
                  <View style={styles.vehicleInfo}>
                    ...
                    <Text style={styles.vehicleMeta}>
                      {[vehicle.brand, vehicle.model, vehicle.year].filter(Boolean).join(' • ') || vehicle.fuelType}
                    </Text>
                  </View>
                  <TouchableOpacity 
            ...
            <TouchableOpacity style={styles.emptyVehicles} onPress={openAddModal}>
                  ...
                  {FUEL_TYPES.map((fuel) => (
                    <TouchableOpacity
                      ...
                      style={[
                        ...
                        vehicleForm.fuelType === fuel.value && styles.fuelTypeOptionSelected,
                      ]}
                      onPress={() => setVehicleForm(prev => ({ ...prev, fuelType: fuel.value }))}
                    >
                      <FontAwesome 
                      ...
                      <Text style={[
                        styles.fuelTypeText,
                        vehicleForm.fuelType === fuel.value && styles.fuelTypeTextSelected,
                      ]}>
                        {fuel.label}
                      </Text>
                    </TouchableOpacity>
                      ...
                      {brandSuggestions.map((brand, index) => (
                        <TouchableOpacity
                          ...
                          style={[
                            ...
                            index === brandSuggestions.length - 1 && { borderBottomWidth: 0 }
                          ]}
                ...
                <View style={styles.autocompleteContainer}>
                  <View style={styles.inputContainer}>
                    ...
                    <TextInput
                      ...
                      onFocus={() => {
                        if (vehicleForm.brand) {
                          const sugs = getModelSuggestions(vehicleForm.brand, vehicleForm.model);
                      ...
                      <ScrollView style={{ maxHeight: 200 }} nestedScrollEnabled>
                        {modelSuggestions.map((model, index) => (
                          <TouchableOpacity
                            ...
                            style={[
                              styles.suggestionItem,
                              index === modelSuggestions.length - 1 && { borderBottomWidth: 0 }
                            ]}
                    ...
                    <TextInput
                      ...
                      onFocus={() => {
                        if (vehicleForm.brand && vehicleForm.model) {
                          const engines = getEngineSuggestions(vehicleForm.brand, vehicleForm.model);
                          setEngineSuggestions(engines);
                          setShowEngineSuggestions(engines.length > 0);
                        }
                      }}
                      ...
                      <ScrollView style={{ maxHeight: 200 }} nestedScrollEnabled>
                        {engineSuggestions.map((engine, index) => (
                          <TouchableOpacity
                            ...
                            style={[
                              styles.suggestionItem,
                              index === engineSuggestions.length - 1 && { borderBottomWidth: 0 }
                            ]}
              ...
              <View style={styles.formSection}>
                ...
                <View style={styles.inputContainer}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(v) => setVehicleForm(prev => ({ ...prev, year: v }))}
                  />
                </View>
              </View>
